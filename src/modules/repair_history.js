...
export async function initRepairHistory(container, storeId = null) {
 ...
 <button id="edit-repair-from-view-btn" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded font-medium transition-colors flex items-center gap-2">
 ...
 <button id="save-edit-repair-btn" type="button" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded font-medium transition-colors flex items-center gap-2">
