...
export async function initStoreManagement(container) {
 ...
 <div class="w-10 h-10 rounded-xl bg-blue-600 flex items-center justify-center text-white font-bold text-sm shadow-sm">
 ${s.name.charAt(0)}
 </div>
 <div>
 ...
 <td class="p-3">
 <span class="px-2 py-0.5 rounded-full text-[10px] font-bold ${u.role === 'main_admin' ? 'bg-blue-50 text-blue-600' : 'bg-blue-50 text-blue-600'}">
